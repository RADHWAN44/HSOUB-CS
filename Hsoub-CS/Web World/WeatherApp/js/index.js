...
function getWeather(){
    ...
    if(city != ''){
        ...
        $("#error").html("<div class='alert alert-danger' id='errorCity'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>الرجاء ادخال اسم المدينة بالانجليزية</div>");
